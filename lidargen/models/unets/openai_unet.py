...
class OpenAIUNetModel(nn.Module):
    ...
    def __init__(
            ...
            legacy=True,
            lib_name='ldm',
            coords_encoding=None,  # custom support for spatial coordinates encoding
    ):
        super().__init__()
    ...
    def forward(self, x, condition_dict, y=None, **kwargs):
        """
        ...
        timesteps = condition_dict['time_condition']
        context = condition_dict.get('other_condition', None)
        hs = []
