...
from lidargen.metrics.extractor.pointmlp import pointMLP
from lidargen.metrics.utils import Logger, mkdir_p, progress_bar, save_model, save_args, cal_loss
from lidargen.metrics.datasets.nuscenes_object_dataset import NuscObject
...
def main():
    ...
    if args.msg is None:
        ...
        message = "-" + args.msg
    args.checkpoint = '../pretrained_models/evaluation/nuscenes/pointmlp'
    ...
    train_loader = DataLoader(NuscObject(partition='train'), num_workers=args.workers,
                              batch_size=args.batch_size, shuffle=True, drop_last=True)
    test_loader = DataLoader(NuscObject(partition='val'), num_workers=args.workers,
