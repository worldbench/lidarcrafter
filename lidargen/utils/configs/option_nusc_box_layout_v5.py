'''
1. Use all sample for training
2. With condition mask loss weight
3. Extend samples for unbanlanced classes geometry and classification
4. A new box condtion insert method
5. With ego motion state
'''
...
class ConditionModelConfig:
    architecture: str = "layout_encoder_v5"
    params: dict = field(
        default_factory=lambda: {
...
@dataclass
class NUSC_Box_Layout_V5_Config:
