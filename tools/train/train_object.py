...
def train(args):
    ...
    project_dir = Path(cfg.training.output_dir) / args.cfg /cfg.data.dataset
    ...
    if cfg.resume is not None:
        ddpm, model, global_step, optimizer_dict, lr_scheduler = inference.load_model_object_duffusion_training(cfg)

    else:
        ddpm, model = inference.load_model_object_duffusion_training(cfg)
